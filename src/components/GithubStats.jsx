  ...
  return (
    <div ref={sectionRef} className="w-full mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="stats-card opacity-0 glass border border-white/10 rounded-3xl p-6 lg:p-10 flex flex-col items-center justify-center hover:border-white/20 transition-all duration-300 min-h-[400px]">
