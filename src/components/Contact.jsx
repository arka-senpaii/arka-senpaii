...
const Contact = () => {
  ...
  const handleRipple = (e) => {
    ...
    ripple.style.background = 'rgba(167, 139, 250, 0.15)';
  ...
  return (
    <footer ref={sectionRef} id="contact" className="py-20 lg:py-32 px-6 md:px-12 lg:px-20 max-w-7xl mx-auto text-center border-t border-white/5 mt-20 relative">
      ...
      >
        <h2 ref={headingRef} className="text-[clamp(3rem,6vw,5rem)] font-bold mb-16 tracking-tighter">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-12">
          <a
            ...
            className="group flex items-center gap-4 text-xl md:text-2xl text-white/80 hover:text-white transition-colors relative overflow-hidden"
        ...
        <div className="flex justify-center items-center gap-6 mb-24">
          <a
            ...
            className="group p-3 rounded-full border border-white/10 hover:border-accent-purple/50 hover:bg-accent-purple/10 transition-all duration-300"
            onMouseEnter={handleRipple}
          >
